...
-- Behavior of an enemy with a sword
-- that goes towards the hero if he sees him
-- and walks randomly otherwise.
-- The sword and the rest of the enemy are two
-- different sprites.
-- If the hero hits the sword of the enemy, the enemy
-- is not hurt but is pushed back.
